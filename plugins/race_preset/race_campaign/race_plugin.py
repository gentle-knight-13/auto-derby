...
_start = datetime.datetime(2022, 9, 26, 12, 0, tzinfo=JST)
_end = datetime.datetime(2022, 10, 3, 4, 59, tzinfo=JST)
_add_campaign(OneTimeCampaign(_start, _end, "キーンランドカップ", order_lte=1))
_add_campaign(OneTimeCampaign(_start, _end, "セントウルステークス", order_lte=1))
_add_campaign(OneTimeCampaign(_start, _end, "スプリンターズステークス", order_lte=1))