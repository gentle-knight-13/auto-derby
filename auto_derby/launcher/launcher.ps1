...
$env:AUTO_DERBY_PAUSE_ON_SPECIFIED_TURN_1 = $data.PauseOnSpecifiedTurn1
$env:AUTO_DERBY_PAUSE_ON_SPECIFIED_TURN_2 = $data.PauseOnSpecifiedTurn2
$env:AUTO_DERBY_PAUSE_ON_SPECIFIED_TURN_3 = $data.PauseOnSpecifiedTurn3
...
set "AUTO_DERBY_PAUSE_ON_SPECIFIED_TURN_1=$($env:AUTO_DERBY_PAUSE_ON_SPECIFIED_TURN_1)"
set "AUTO_DERBY_PAUSE_ON_SPECIFIED_TURN_2=$($env:AUTO_DERBY_PAUSE_ON_SPECIFIED_TURN_2)"
set "AUTO_DERBY_PAUSE_ON_SPECIFIED_TURN_3=$($env:AUTO_DERBY_PAUSE_ON_SPECIFIED_TURN_3)"
